					...
					<div class="row">
						<div class="col-lg-12">
							<div class="d-flex flex-wrap flex-wrap align-items-center justify-content-between mb-4">
								<div>
									<h4 class="mb-3">Errand's Panel</h4>
								</div>
								<a href="errand_addform.php?action=addNew" class="btn btn-danger add-list"><i class="las la-plus mr-3"></i>Add New Errand</a>
							</div>
						</div>
							...
							<table class="data-tables table mb-0 tbl-server-info table-hover shadow-bottom shadow-showcase" id="vendor_table">
								...
								<tbody class="ligth-body">
									<?php 
										...
										$sql = "SELECT CONCAT(A.firstname ,' ', A.mi,'. ', ' ', A.lastname) AS Fullname, (C.del_fee) AS delivery_fee,
												A.* , B.image
												FROM $tablename AS A
										...
										if($get_vendor_list){
											foreach($get_vendor_list as $row){
												$errand_name 	 = $row->firstname." ".$row->mi.". ".$row->lastname;
												$contact 		 = $row->contact;
										...
										<td>
											<div class="d-flex align-items-center list-action">
												<a class="badge bg-success mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"
													href="errand_addform.php?action=edit&id=<?= $id;?>"><i class="ri-pencil-line mr-0"></i></a>
												<a class="badge bg-warning mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"
													onclick="delete_errand(<?= $id;?>)" href="#"><i class="ri-delete-bin-line mr-0"></i></a>
											</div>
										</td>
									</tr>
									<?php }}?>
