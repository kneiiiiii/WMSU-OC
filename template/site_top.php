...
<head>
    ...
    <!-- Page Title -->
    <title>WMSU | Onlince Canteen</title>
	<link rel="shortcut icon" href="site_assets/img/n_logo.png" /> 
    <!-- Meta Description -->
    ...
    <!-- jquery.fancybox  -->
    <link rel="stylesheet" href="site_assets/css/jquery.fancybox.css">
    <!-- animate -->
    <link rel="stylesheet" href="site_assets/css/animate.css">
    <!-- Main Stylesheet -->
    <link rel="stylesheet" href="site_assets/css/main.css">
    <!-- media-queries -->
    <link rel="stylesheet" href="site_assets/css/media-queries.css">
	
    <!-- Modernizer Script for old Browsers -->
    <script src="site_assets/js/modernizr-2.6.2.min.js"></script>
