$(document).ready(function()
{
	...
	$("#frmLogin_errand").submit(function()
	{
		...
		$.post("login_process_errand.php",{ email_add_errand:$('#email_add_errand').val(),pass_word_errand:$('#pass_word_errand').val()} ,function(data)
        {
		  if(data=='yes') //if correct login detail
		  {
		  	$("#login-indicator-msg").fadeTo(200,0.1,function()  { //start fading the messagebox
              	...
              	function() { 
			  		document.location='page_errand_orderlist.php';
			  	});			  
			});
		  } else {
