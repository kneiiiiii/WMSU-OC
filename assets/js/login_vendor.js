$(document).ready(function()
{
	...
	$("#frmLogin_vendor").submit(function()
	{
		...
		$.post("login_process_vendor.php",{ email_add:$('#email_add').val(),pass_word:$('#pass_word').val()} ,function(data)
        {
		  if(data=='yes') //if correct login detail
		  {
		  	$("#login-indicator-msg").fadeTo(200,0.1,function()  { //start fading the messagebox
              	...
              	function() { 
			  		document.location='page_vendor_foodlist.php';
			  	});			  
			});
		  } else {
