$(document).ready(function()
{
	...
	$("#frmLogin_customer").submit(function()
	{
		...
		$.post("login_process_customer.php",{ email_add:$('#email_add').val(),pass_word:$('#pass_word').val()} ,function(data)
        {
		  if(data=='yes') //if correct login detail
		  {
		  	$("#login-indicator-msg").fadeTo(200,0.1,function()  { //start fading the messagebox
              	...
              	function() { 
			  		document.location='page_customer_foodslist.php';
			  	});			  
			});
		  } else {
